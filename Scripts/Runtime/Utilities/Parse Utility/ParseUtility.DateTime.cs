...
namespace JvLib.Utilities
{
    ...
    {
        /// <summary>
        /// Attempts to parse a string with the given seperator to a DateTime, using the default fallback upon a failure
        /// </summary>
        ...
        {
            if (DateTime.TryParseExact(pString, pFormat, null, System.Globalization.DateTimeStyles.None, out DateTime result)) return result;
            return pDefault;
        }
    }
}
